...
PRODUCT_COPY_FILES += \
    vendor/cyclone/config/permissions/cyclone-sysconfig.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/sysconfig/cyclone-sysconfig.xml

# Copy all cyclone-specific init rc files
