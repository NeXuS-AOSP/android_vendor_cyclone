...
PRODUCT_COPY_FILES += \
    ...
    vendor/cyclone/prebuilt/common/bin/50-aosp.sh:$(TARGET_COPY_OUT_SYSTEM)/addon.d/50-aosp.sh
...
PRODUCT_PACKAGES += \
    vendor/cyclone/prebuilt/common/etc/sensitive_pn.xml:$(TARGET_COPY_OUT_SYSTEM)/etc/sensitive_pn.xml
...
PRODUCT_ENFORCE_RRO_EXCLUDED_OVERLAYS += vendor/cyclone/overlay
PRODUCT_PACKAGE_OVERLAYS += vendor/cyclone/overlay/common

PRODUCT_BUILDTYPE ?= UNOFFICIAL
PRODUCT_VERSION_MAJOR = 12.1
PRODUCT_VERSION_MINOR = Vortex

CYCLONE_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)-$(shell date -u +%Y%m%d)-$(PRODUCT_BUILDTYPE)
CYCLONE_DISPLAY_VERSION := $(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR)
